...
window = tk.Tk()
window.title("FAMS-Face Recognition Employee  Attendance Based Management System")
...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            ...
            connection = pymysql.connect(
                host='localhost', user='root', password='', db='py')
        ...
        if subb == '':
            ...
            def err_screen1():
                ...
                Label(errsc2, text='Please enter Employee & Enrollment!', fg='black', bg='white',
            ...
            EMP_NAME = tk.Label(MFW, text="Enter Employee name", width=15, height=2, fg="black", bg="grey",
                                font=('times', 15))
            EMP_NAME.place(x=30, y=200)
            ...
            EMPLOYEE_ENTRY.place(x=290, y=205)

            def remove_employee():
                EMPLOYEE_ENTRY.delete(first=0, last=22)
            ...
            def create_csv():
                ...
                csv_name = 'D:/aarthi - Copy/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            c1ear_student = tk.Button(MFW, text="Clear", command=remove_employee, fg="white", bg="black", width=10,
                                      height=1,
                                      activebackground="white", font=('times', 15, ' bold '))
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:/aarthi - Copy/Attendance/Manually Attendance/-------Check atttendance-------"')
    ...
    SUB = tk.Label(sb, text="Enter Department : ", width=15, height=2,
...
def err_screen1():
    ...
    Label(sc2, text='Please enter your Department name!!!', fg='black',
          bg='white', font=('times', 16)).pack()
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(
                        host='localhost', user='root', password='', db='ra')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='grey80')
                cs = r'D:/aarthi - Copy/Attendace_management_system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:/aarthi - Copy/TrainingImage/Attendance/-------Check atttendance-------"')

    attf = tk.Button(windo,  text="Check Sheets", command=Attf, fg="white", bg="black",
                     width=12, height=1, activebackground="white", font=('times', 14, ' bold '))
    attf.place(x=430, y=255)

    sub = tk.Label(windo, text="Enter Department : ", width=15, height=2,
    ...
    def log_in():
        ...
        if username == 'aarthi':
            if password == 'aarthi':
                ...
                cs = 'D:/aarthi - Copy/EmployeeDetails/EmployeeDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="FaceRecognition Attendance Employee  Management System", bg="black", fg="white", width=50,
...
AP = tk.Button(window, text="Check Registered Employee", command=admin_panel, fg="black",
